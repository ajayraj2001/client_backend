...
const chadawaRoutes = require("./adminRoutes/chadawaRoute");
...
const notificationRoutes = require("./adminRoutes/notificationRoute");
...
adminRoute.use('/chadawa', chadawaRoutes);
