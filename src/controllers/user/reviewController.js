...
// const PujaReview = require('../../models/PujaReview');
// const Puja = require('../../models/Puja');
// const PujaTransaction = require('../../models/PujaTransaction');
...
//             .skip(skip)
//             .limit(limit)
//             .populate('userId', 'name profilePicture') // Adjust fields as per your User model
//             .lean();
...
// // Admin-only: Get all product reviews
...
//         if (req.query.verifiedPurchase) query.verifiedPurchase = req.query.verifiedPurchase === 'true';
